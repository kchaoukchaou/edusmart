 ...
 */
final class Version20200411090030 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE under_study_level CHANGE study_level_id study_level_id INT DEFAULT NULL');
